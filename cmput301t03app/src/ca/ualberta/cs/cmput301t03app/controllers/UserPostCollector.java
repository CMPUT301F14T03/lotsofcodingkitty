...
/**
 * A model that contains all user specific lists containing ID's and a question
 * bank containing a list of Question objects. All lists are populated by
 * loading from LocalDataManager.
 * 
 */
public class UserPostCollector
{
	...
	// This method is for testing since each test needs to start with a fresh
	// list
...
// This is a constructor that is used when the UPC is created using the
// LocalDataManagers loading methods
// Unsure about this constructor.....

// public UserPostCollector(ArrayList<String> favoriteQuestions,
// ArrayList<String> readQuestions,
// ArrayList<String> toReadQuestions, ArrayList<String> postedQuestions,
// ArrayList<String> postedAnswers) {
