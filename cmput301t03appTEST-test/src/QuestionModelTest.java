...
public class QuestionModelTest extends
	...
	/**
	 * Tests the method upRating in the question Object That when called, the
	 * rating attribute of the comment will be incremented by one point.
	 */
	...
	public void testIncreaseQuestionScoreby30() {
		...
		assertEquals("Rating is 1", 31, q1.getRating());
	}
	...
	public void testAddAnswer() {
		...
		assertNotSame("a1 is a2", q1.getAnswers().get(0), q1.getAnswers()
	 ...
	 */
	public void testAnswerCountby10() {
		Question q1 = new Question("a subject", "a body", "a author");
		Answer a1 = new Answer("a body", "a author", "1");
		q1.addAnswer(a1);
		assertEquals("Answer count  is 1", 1, q1.countAnswers());
		...
		q1.addAnswer(a3);
		assertEquals("Answer count is 3", 2, q1.countAnswers());
	}
	...
	public void testAddComment() {
		...
		assertNotSame("c1 is not c2", q1.getComments().get(0), q1.getComments()
				.get(1));
